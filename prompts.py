...
Stock Recommendations Linked to Events (Analysis):
  ...
  **Date**: Provide the date when you suggest to buy the stock and when to sell it.
...
You should prepare this report by doing the following actions in exact order:
* ACTION: read/analyze latest financial news (do any required googling and reading)
* ACTION: read/analyze finanice calendar for the next week
* ACTION: based on the analysis pick several stock
* ACTION: for each stock read/analyze latest news about the stock/ticker and adjust list of stocks as needed (it is ok to go back to previouse step)
* ACTION: write the report

in the end:
   * print: "This is NOT an investment advice"
